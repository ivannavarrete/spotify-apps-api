...
function TokenInput() {
	...
	backspacePressed = r.filter(function(e) { return 8 === e.keyCode; },
...
function setupAutoComplete(tokenInput) {
	...
	r.switch(inputFocus, function(e) {
		return r.takeUntil(inputBlur, escapes);
	}).subscribe(function(e) {
		output.classList.remove("show");
	});

	r.switch(nodeFocus, function(e) {
	...
	r.switch(outputFocus, function(e) {
...
TokenInput.prototype.getValues = function() {
	return map(function(t) { return t.value; }, this.tokens);
};
...
function artistsString(as) { return lang.truncate(map(function(a) { return a.name; }, as).join(", "), 30); };
